-- 0018_claim_assignee_test.sql — runnable self-check for the agent-attribution
...
--          -f db/migrations/0018_claim_assignee.sql \
--          -f db/migrations/0018_claim_assignee_test.sql
--
