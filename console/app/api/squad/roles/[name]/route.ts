// app/api/squad/roles/[name]/route.ts — BFF role-authoring-detail proxy (ISI-4002, ADR-0016).
//
// GET-ONLY. Proxies the apiserver's per-kind authoring-spec read
// (GET /api/squad/roles/{name}, fleetlist.go) — the compose WRITE wire shape the
// Compose EDIT form hydrates from so opening a role shows its real spec and a PUT
